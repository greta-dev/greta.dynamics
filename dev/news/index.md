...
- Resolved an issue where
  ...
  could not be used in a model sampled with `mcmc()`. This was a result
  of greta using `.batch_size` over `batch_size` - see
  <https://github.com/greta-dev/greta/issues/634>. We now use
  `.batch_size`. Tests Added to catch this in the future.
