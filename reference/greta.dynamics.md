...
an extension to [greta](https://greta-stats.org/) with functions for
simulating dynamical systems, defined by of ordinary differential
equations (see
[`ode_solve()`](https://greta-dev.github.io/greta.dynamics/reference/ode_solve.md))
